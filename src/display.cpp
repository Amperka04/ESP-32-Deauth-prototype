...
/*
 * ====================================================================
 *  Реализация функций для управления TFT-дисплеем.
 *  Здесь настраиваются пины питания и ШИМ подсветки,
 *  а также выполняются начальные установки библиотеки TFT_eSPI.
 * ====================================================================
 */

// Определение глобального объекта дисплея (экземпляр класса TFT_eSPI)
...
void initDisplay() {
    ...
    tft.init();
    tft.setRotation(3);         // Ориентация экрана: 3 - мне так удобно
